            ...
            <AnimatePresence mode="wait">
              {!active ? (
                ...
                >
                  ...
                  {active.role && (
                    <p className="hud-label mt-3 text-foreground/60">{(en && active.roleEn) || active.role}</p>
                  )}
                  ...
                  <div className="mt-10 columns-1 gap-6 sm:columns-2 lg:columns-3">
                    {active.media.map((m) => (
                      <img
                        ...
                        alt={m.alt}
                        loading="lazy"
                        className="mb-6 w-full break-inside-avoid rounded-2xl border border-border/60 shadow-[var(--shadow-depth)]"
                      />
                    ))}
                  </div>
                </motion.div>
